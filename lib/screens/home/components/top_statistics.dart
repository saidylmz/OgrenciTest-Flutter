                ...
                child: Row(
                  ...
                  children: <Widget>[
                    HomeStatQuestionText(
                      title: "Toplam",
                      text: controller.userStatistic.questionCount.toString() +
                          " soru",
                    ),
                    SizedBox(width: getProportionateScreenWidth(15)),
                    HomeStatQuestionText(
                      title: "Doğru",
                      text: controller.userStatistic.correctQuestionCount
                          .toString(),
                    ),
                    SizedBox(width: getProportionateScreenWidth(15)),
                    HomeStatQuestionText(
                        title: "Yanlış",
                        text: controller.userStatistic.wrongQuestionCount
                            .toString()),
                    SizedBox(width: getProportionateScreenWidth(15)),
                    HomeStatQuestionText(
                        title: "Boş",
